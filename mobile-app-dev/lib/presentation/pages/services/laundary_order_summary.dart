...
import 'controller/laundary_order_summary_controller.dart';

class LaundaryOrderSummary extends GetView<LaundaryOrderSummaryController> {
  const LaundaryOrderSummary({super.key});
        ...
        child: CommonButton(
          onPress: () {
            Get.toNamed(RouteConst.confirmOrderPage, arguments: {
              ...
              "requestName": Strings.strLaundaryService,
