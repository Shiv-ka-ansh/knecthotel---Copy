...
class UploadPicture extends GetView<UploadPictureController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CommonButton(
          onPress: () {
            Get.toNamed(RouteConst.bookingSelection);
          },
            ...
            Align(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: () => Get.toNamed(RouteConst.bookingSelection),
                      child: const Padding(
